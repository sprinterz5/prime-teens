      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        {(eyebrow || title || subtitle) && (
          <div className="mb-10 max-w-3xl">
            {eyebrow && <p className={isLight ? "eyebrow eyebrow-on-light mb-4" : "eyebrow mb-4"}>{eyebrow}</p>}
            {title && <h2 className="font-display text-3xl font-bold leading-tight sm:text-4xl">{title}</h2>}
            {subtitle && (
